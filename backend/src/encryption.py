...
# password = "_BIM8o0oRI4uttmSyp67VnQZQp7-megO7r48Uzi8Apo="  # كلمة مرور قوية
# tpe = TPE(password)

# # تشفير رسالة
# encrypted = tpe.encrypt_message("Sensitive Data Here!")
# print("Encrypted:", encrypted)

# # فك تشفير الرسالة
# try:
#     decrypted = tpe.decrypt("Xf/RM29RjHH5hSgpI4w4TLM0BC2OWzuN9s8Jwemi835Ier4gSCXF7POLRk6yLQwutbZLHnkL")
